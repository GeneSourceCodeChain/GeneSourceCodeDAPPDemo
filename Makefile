...
LIBS=-L/usr/lib/x86_64-linux-gnu/ `pkg-config --libs libcrypto++` -lboost_program_options -lboost_filesystem -lboost_system -lboost_regex -lboost_iostreams -lpthread
...
install: eosfilestore
	cleos --wallet-url http://192.168.1.100:6666 -u http://192.168.1.100:8001 wallet import --private-key 5JzUiVhF1MYB4U391RmpsFTdeH9vBHhubmiT6tGzQacfBgqUmo2
